...
class TestLayer(torch.nn.Module):
    ...
    def forward(
        ...
        x_0_level1 = self.aggr([x_0_to_0])
        x_1_level1 = self.aggr([x_1_to_1])
        x_2_level1 = self.aggr([x_2_to_2])
        x_3_level1 = self.aggr([x_3_to_3])
        x_4_level1 = self.aggr([x_4_to_4])
        ...
        # Aggregation of messages for each node
        x_0_level2 = self.aggr([x_1_to_0])
        x_1_level2 = self.aggr([x_2_to_1])
        x_2_level2 = self.aggr([x_3_to_2])
        x_3_level2 = self.aggr([x_4_to_3])
        x_4_level2 = self.aggr([x_4_level1])
