...
def load_and_prepare_data(num_list, data_dir, label_filename, test_size):
    ...
    (y_train, y_test), (x_0_train, x_0_test), (x_1_train, x_1_test), (x_2_train, x_2_test), (x_3_train, x_3_test), \
    (n0_to_0_train, n0_to_0_test), (n1_to_1_train, n1_to_1_test), (n2_to_2_train, n2_to_2_test), \
    (n0_to_1_train, n0_to_1_test), (n1_to_2_train, n1_to_2_test) = split_data(
        y_list, x_0_list, x_1_list, x_2_list, x_3_list, 
...
def main(args):
    ...
    train_dataset, test_dataset = load_and_prepare_data(
        num_list, args.data_dir, args.label_filename, args.test_size
    )
    ...
    train(model, train_dataset, test_dataset, loss_fn, opt, args.num_epochs, args.test_interval, args.device, checkpoint_path)
    
    # Evaluate the model
    logging.info("Starting evaluation")
    evaluate(model, test_dataset, args.device)
